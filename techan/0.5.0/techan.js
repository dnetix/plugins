...
!function (e) {
    if ("object" == typeof exports && "undefined" != typeof module)
        ...
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.techan = e()
    }
}(function () {
        ...
        3: [function (require, module, exports) {
            ...
            module.exports = function () {
                var date = function (d) {
                    ...
                    tenkanSen = function (d) {
                        return d.tenkanSen;
                    },                  // Conversion line
                    kijunSen = function (d) {
                        return d.kijunSen;
                    },                    // Base Line
                    senkouSpanA = function (d) {
                        return d.senkouSpanA;
                    },              // Leading Span A
                    senkouSpanB = function (d) {
                        return d.senkouSpanB;
                    },               // Leading Span B
                    chikouSpan = function (d) {
                        return d.chikouSpan;
                    },                 // Lagging Span
                // Functions to get to the parameters
                    ptenanSen = function (d) {
                        return d.parameters.tenkanSen;
                    },       // Parameter: Conversion Line Period
                    pkijunSen = function (d) {
                        return d.parameters.kijunSen;
                    },        // Parameter: Base Line Period, Offset
                    psenkouSpanB = function (d) {
                        return d.parameters.senkouSpanB;
                    };  // Parameter: Senkou Span B Period, Offset
...
// TODO Provide IDs for all accessors. Default to date, but at least provide an option
        ...
        13: [function (require, module, exports) {
            ...
            module.exports = function (indicatorMixin, accessor_ohlc, alpha_init) {  // Injected dependencies
                return function () { // Closure function
                    ...
                    function indicator(data) {
                        indicator.init();
                        return data.map(ma).filter(function (d) {
                            return d.value !== null;
                        });
                    }
            ...
            function backgroundPath(accessor, axis, height, width, point, neg) {
                return function (d) {
                    ...
                    switch (axis.orient()) {
                        ...
                        default:
                            throw "Unsupported axis.orient() = " + axis.orient();
                    }
                };
            }
        }, {}],
            ...
            module.exports = function (d3_select, d3_event, d3_mouse, d3_dispatch, plot, plotMixin) { // Injected dependencies
                return function () { // Closure function
                    ...
                    function crosshair(g) {
                        var group = g.selectAll('g.data.top').data([change], function (d) {
                                return d;
                            }),
                        ...
                        g.selectAll('rect').data([0]).enter().append('rect').style({
                            fill: 'none',
                            'pointer-events': 'all'
                        });
                ...
                return function () { // Closure function
                    ...
                    function kumoClipArea() {
                        return d3_svg_area().interpolate('monotone')
                            .defined(function (d) {
                                return p.accessor.sb(d) !== null;
                            })
                            .x(function (d) {
                                return p.xScale(p.accessor.d(d), p.accessor.pks(d));
                            })
                            .y0(function (d) {
                                return p.yScale(p.accessor.sb(d));
                            });
                    }
                    ...
                    function kumoPathArea() {
                        return d3_svg_area().interpolate('monotone')
                            .defined(function (d) {
                                return p.accessor.sa(d) !== null && p.accessor.sb(d) !== null;
                            })
                            .x(function (d) {
                                return p.xScale(p.accessor.d(d), p.accessor.pks(d));
                            })
                            .y0(function (d) {
                                return p.yScale(p.accessor.sa(d));
                            })
                            .y1(function (d) {
                                return p.yScale(p.accessor.sb(d));
                            });
            ...
            module.exports = function (d3_svg_line, d3_select) {
                ...
                function PathLine() {
                    ...
                    line.init = function (accessor_date, x, accessor_value, y, offset) {
                        return d3Line.defined(function (d) {
                            return accessor_value(d) !== null;
                        })
                            .x(function (d) {
                ...
                return {
                    ...
                    annotation: {
                        append: function (selection, annotations, clazz, accessor, scale) {
                            ...
                            annotationSelection.enter().append('g').attr('class', function (d, i) {
                                return i;
                            })
                                .each(function (d, i) {
            ...
            module.exports = function (d3_behavior_drag, d3_event, d3_select, d3_dispatch, accessor_value, plot, plotMixin) {  // Injected dependencies
                function Supstance() { // Closure function
                    ...
                    function supstance(g) {
                        ...
                        var interaction = group.entry.append('g').attr('class', 'interaction').style({
                            opacity: 0,
                            fill: 'none'
                        })
                ...
                return {
                    ...
                    plot: {
                        ...
                        percent: function (scale, reference) {
                            ...
                            return scale.copy().domain([domain[0], domain[domain.length - 1]].map(function (d) {
                        ...
                        atrtrailingstop: function (data, accessor) {
                            ...
                            var values = mapReduceFilter(data, function (d) {
                                return [accessor.up(d), accessor.dn(d)];
                            });
        ...
        }, {"../accessor": 4, "../util": 39, "./financetime": 35, "./zoomable": 37}],
        ...
        }, {"../build/version": 1, "./accessor": 4, "./indicator": 15, "./plot": 25, "./scale": 36}],
